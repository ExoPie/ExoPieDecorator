...
void createRegion(RooRealVar met, TH1F* h_sr_bkg , TH1F* h_cr_bkg, 
  ...
  */
  ...
  RooFormulaVar rfv_cr_bkg2("rfv_"+region_proc_cr+"2"+anacat_,"Background yield in control region, bin 2","(1.0/@0)*@1",RooArgList(TF1,rrvbc_sr_bkg.at(1)));
  RooFormulaVar rfv_cr_bkg3("rfv_"+region_proc_cr+"3"+anacat_,"Background yield in control region, bin 3","(1.0/@0)*@1",RooArgList(TF1,rrvbc_sr_bkg.at(2)));
  RooFormulaVar rfv_cr_bkg4("rfv_"+region_proc_cr+"4"+anacat_,"Background yield in control region, bin 4","(1.0/@0)*@1",RooArgList(TF1,rrvbc_sr_bkg.at(3)));
...
void PrepareWS_withnuisanceInvertTF_1binTF(TString model_="monoHbb",TString analysiscategory_="merged", TString mode__ = "RECREATE", TString inputdir=".", TString inputfile="AllMETHistos.root", TString year="2016", TString version     = "_V0"){
